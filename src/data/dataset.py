...
class InpaintingData(Dataset):
    def __init__(self, args):
        ...
        self.common_crop = transforms.RandomResizedCrop(args.image_size)
    def __len__(self):
    ...
    def __getitem__(self, index):
        ...
        #print(f"Mask type: {self.mask_type}, mask size: {mask.size}",image.size)
        ...
        #print(f"Mask type: {self.mask_type}, mask size: {mask.shape}",image.shape)
